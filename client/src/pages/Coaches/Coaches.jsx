...
const Coaches = () => {
  ...
  const coaches = [
    { id: 'SFM2301N1', name: 'Coach 1', contact: 'Jan 11', dateExpiration: 'Feb 11' },
    { id: 'SFM2301N2', name: 'Coach 2', contact: 'Jan 11', dateExpiration: 'Feb 11' },
    { id: 'SFM2301N3', name: 'Coach 3', contact: 'Jan 11', dateExpiration: 'Feb 11' }
  ];
  ...
  return (
    <PageContainer>
      ...
      <MainContent>
        ...
        <AddCoachButton onClick={() => setShowAddModal(true)}>
          Add Coach
        </AddCoachButton>
